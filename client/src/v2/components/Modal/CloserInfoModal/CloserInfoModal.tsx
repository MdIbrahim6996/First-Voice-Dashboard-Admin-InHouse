...
import MonthlyLeadsClosed from "./elements/MonthlyLeadsClosed";
import MonthlyLeadsVerified from "./elements/MonthlyLeadsVerified";

const CloserInfoModal = ({
    handleClose,
    userId,
}: {
    handleClose: () => void;
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="px-4 py-2">
                    <div>
                        <div className="border border-slate-200 bg-slate-200 shadow-2xl rounded-md flex justify-between items-center">
                            ...
                            <button
                                onClick={() => setSelectedTab("leads-closed")}
                                className={` ${
                                    selectedTab === "leads-closed"
                                        ? "bg-white font-[500]"
                                        : "bg-slate-200"
                                } rounded-md flex-1 text-center capitalize m-1 cursor-pointer hover:font-[500]`}
                            >
                            ...
                            <button
                                onClick={() => setSelectedTab("leads-verified")}
                                className={` ${
                                    selectedTab === "leads-verified"
                                        ? "bg-white font-[500]"
                                        : "bg-slate-200"
                                } rounded-md flex-1 text-center capitalize m-1 cursor-pointer hover:font-[500]`}
                            >
                ...
                {selectedTab === "leads-closed" && (
                    <MonthlyLeadsClosed userId={userId} />
                )}
                {selectedTab === "leads-verified" && <MonthlyLeadsVerified userId={userId} />}
...
export default CloserInfoModal;
