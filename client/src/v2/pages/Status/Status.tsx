...
import CreateStatus from "../../components/Modal/Status/Create";
import DeleteModal from "../../components/Modal/DeleteModal/DeleteModal";
import EditStatus from "../../components/Modal/Status/Edit";
                            ...
                            <tbody>
                                {status?.map((item: any, i: number) => (
                                    ...
                                    >
                                        ...
                                        <td className="pl-12 py-4 flex gap-1 items-center ">
                                            <button
                                                onClick={() => {
                                                    setId(item.id);
                                                    setShow({
