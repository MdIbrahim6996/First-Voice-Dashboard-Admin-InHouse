...
import PlanInfoModal from "../../components/Modal/Plan/Info";
                        ...
                        <table className="w-full text-sm text-left rtl:text-right text-gray-500 ">
                            ...
                            <tbody>
                                {plan?.map((item: any, i: number) => (
                                    <tr
                                        key={item?.id}
                                        className="capitalize text-slate-900 font-semibold odd:bg-white odd::bg-gray-900 even:bg-gray-50 even::bg-gray-800 border-b :border-gray-700 border-gray-200"
                                    >
                                        <th
                                            scope="row"
