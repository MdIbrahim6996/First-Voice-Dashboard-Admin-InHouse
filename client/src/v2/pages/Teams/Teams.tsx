...
import TeamInfo from "../../../components/Modal/TeamInfo";
                    ...
                    <div className="mb-5  text-gray-900 bg-white ">
                        ...
                        >
                            ...
                            <button
                                ...
                                className="py-1.5 px-7 bg-blue-700 cursor-pointer text-white rounded-md text-sm flex gap-1 items-center"
                            >
                                <MdAdd className="text-xl" /> Add A Team
                            </button>
                        </motion.div>
                    </div>
                    <motion.div
                        ...
                        <table className="w-full text-sm text-left rtl:text-right text-gray-500 ">
                            ...
                            <tbody>
                                {teams?.map((item: any, i: number) => (
                                    <tr
                                        key={item?.id}
                                        className="capitalize text-center font-medium odd:bg-white odd::bg-gray-900 even:bg-gray-50 even::bg-gray-800 border-b border-gray-200"
                                    >
                                        <th
                                            scope="row"
