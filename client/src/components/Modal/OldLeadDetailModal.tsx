                                ...
                                <div className="my-5">
                                    ...
                                    <div className="grid grid-cols-8 gap-x-4 gap-y-4 ">
                                        ...
                                        <div className="flex flex-col text-sm space-y-0.5">
                                            ...
                                            <p className="border outline-none h-full border-gray-400 px-3 py-1 rounded uppercase h-full">
                                                {details?.card_cvv}
                                            </p>
                                        </div>
                                    </div>
...
export default OldLeadDetailModal;
