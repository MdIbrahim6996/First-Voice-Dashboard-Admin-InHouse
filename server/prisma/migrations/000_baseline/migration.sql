...
CREATE TABLE `user` (
    ...
    INDEX `user_processId_fkey`(`processId`),
    INDEX `user_teamId_fkey`(`teamId`),
    PRIMARY KEY (`id`)
...
CREATE TABLE `plan` (
    ...
    INDEX `plan_processId_fkey`(`processId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `appliance` (
    ...
    INDEX `appliance_leadId_fkey`(`leadId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `lead` (
    ...
    `comment` TEXT NULL,
    `poa` BOOLEAN NULL DEFAULT false,

    INDEX `lead_closerId_fkey`(`closerId`),
    INDEX `lead_leadByUserId_fkey`(`leadByUserId`),
    INDEX `lead_planId_fkey`(`planId`),
    INDEX `lead_processId_fkey`(`processId`),
    INDEX `lead_statusId_fkey`(`statusId`),
    INDEX `lead_verifierId_fkey`(`verifierId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `leadcount` (
    ...
    INDEX `leadcount_userId_fkey`(`userId`),
...
CREATE TABLE `status_change_reason` (
    ...
    INDEX `status_change_reason_leadId_fkey`(`leadId`),
    INDEX `status_change_reason_userId_fkey`(`userId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
